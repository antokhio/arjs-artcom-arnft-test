...
import { ArToolkitContextProps, ArToolkitSourceProps, MarkerControlsProps } from './types';
...
type ARProviderProviderComponent = React.FC<{
    tracking?: boolean;
...
export const ARProvider: ARProviderProviderComponent = ({
    tracking = true,
    children,
    sourceProps,
    contextProps,
    ...
    const onUnmount = useCallback(() => {
        ...
        const video = document.querySelector(videoDomElemSelector) as HTMLVideoElement;
        if (video) {
